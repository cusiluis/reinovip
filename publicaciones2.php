...
.paquete { border: 1px solid #ddd; padding: 20px; margin: 10px; display: inline-block; width: 280px; }
.paquete_personalizado{ border: 1px solid #ddd; padding: 20px; margin: 10px; display: inline-block; width: 795px;  }
                  ...
                  <div class="login-box">	
                      ...
                      <div class="login-box">
                        ...
                        <div class="tab-container">
                            ...
                            <div class="tab-content perfil_agencia" id="tab3">
                                <style>
                                    .site-content {
                                        width:960px;
                                        margin:auto;
                            ...
                            ?>
                                <div class="login-box">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <img src="https://reinovip.com/fotos/<?php echo $imagenAgencia;?>" alt="Imagen Agencia" class="img-circle"/>
                                        </div>
                            ...
                            <div class="login-box">	
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input disabled="disabled" type="text"  class="form-control editAnuncio form_celdainput"  value="<?php echo $_SESSION['email'];?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre_agencia"  class="form-control editAnuncio form_celdainput" style="height: 35px !important;width:235px !important;" value="<?php echo $nombreAgencia;?>">
                                    </div>
                                </div>  
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pais" class="form-control editAnuncio form_selector pais" id="f_pais" onchange="verProvincias(this.value,0)" style="height: 33px !important;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="provincia" onChange="verCiudades(this.value,0)" class="form-control editAnuncio form_selector f_provincia" id="f_provincia" disabled="disabled" style="height: 33px !important;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ciudad" class="form-control editAnuncio form_selector f_ciudad" id="f_ciudad" disabled="disabled" >
                                        <option value="0">---o---</option>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="container">
                                      ...
                                      <!--  <input type="file" name="imagen_agencia"  class="form-control editAnuncio form_celdainput" style="height: 35px !important;width: 30% !important;">-->
                                    </div>
                                </div>  
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="peso">Descripción</label>
                                        <textarea style="height:100px;width:96% !important;" name="descripcion_agencia" id="f_descripcion" cols="70" rows="6" maxleng class="form-control-2 editAnuncio form_campo_comentarios"><?php echo $descrAgencia;?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="nombre">Sitio Web</label>
                                        <input type="text" name="web"  class="form-control editAnuncio form_celdainput" style="height: 35px !important;width: 30% !important;" value="<?php echo $webAgencia;?>">
                                    </div>
                                </div>  
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="nombre">Telefono</label>
                                        <input type="text" name="telefono_1"  class="form-control editAnuncio form_celdainput" style="height: 35px !important;width: 30% !important;" value="<?php echo $telefonoAgencia;?>">
                                    </div>
                                </div>  
                                </div>
                                <div class="col-lg-12">
                            ...
                            <a  style="margin-top:30px;color:#fff;padding:10px 30px;border-radius:5px; width:300px; margin-left:30px;" href="http://reinovip.com/registro.php?id=<?php echo $usuario_id;?>" class="submit-btn" role="button">REGISTRAR NUEVO ANUNCIO</a>
                        </div>
                        <?php endif;?>
                ...
                <style>
                  ...
                  .toggle-btn {
                    ...
                    text-decoration: underline;
								...
								<?php foreach ($list as $data):?>
									<tr>
                                        <td><img src="https://reinovip.com/fotos/<?php echo $data['imagen']?>" style='width:250px;'></td>
                                        ...
                                        <button class="btn btn-primary tab-btn active" onclick="toggleTab(8)">Formulario</button>
                                    ...
                                    <tr>
                                        ...
                                        <h2>SELECCIONA TU PAQUETE <?php echo $_GET['token'];?></h2>
						...
						<?php endif;?>
                         ...
                         <div id="tab8" class="tab-content forms" style="display: none;">
                                <div class="login-box">	
                                    <h2>
                                        EDITAR ANUNCIO
                                    </h2>	
                        ...
                        <div class="login-box">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="f_categoria" class="form-control editAnuncio" id="f_categoria">
                                        <option value="0" >---o---</option>
                                            <?php
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $list[0]['nombre']?>" class="form-control editAnuncio form_celdainput"  maxlength="20" id="f_nombre" name="f_nombre">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div style="float:left;width:130px;">
                                    ...
                                    <input value="<?php echo $list[0]['telefono']?>" name="f_telefono" id="f_telefono"  type="text" class="form-control editAnuncio form_celdainput" maxlength="9" />
                                    </div>
                                    <div style="float:left;width:100px;margin-top: 16px;margin-left: 10px;">
                                    <input id= "f_whatsapp" type="checkbox" name="f_whatsapp" <?php if($list[0]['whatsapp']==1):?>checked<?php endif;?>/><img src="img/wp.png" style="width:14px;margin: 0 4px;"><label style="width:65px;font-size:.7rem;">Whatsapp </label>
                                    <input style="margin-top:0px;" type="checkbox" name="f_telegram" <?php if($list[0]['telegram']==1):?>checked<?php endif;?>/><img src="img/tg.png" style="width:14px;margin: 0 4px;"><label style="width:65px;font-size:.7rem;">Telegram </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="f_edad" id="f_edad"  class="edad form-control editAnuncio">
                                        <option value=""></option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="f_lugares[]" id="f_lugares" class="lugares form-control editAnuncio select2" multiple="multiple">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $list[0]['horario']?>"  name="f_horario" id="f_horario" type="text" maxlength="40"  class="form-control editAnuncio form_celdainput"  />
                                </div>
                            </div>
                            <div class="col-lg-12">
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="pais">Pais:<span class="campObligatorio">&nbsp;&nbsp;*</span></label>
                                        <select name="f_pais" class="form-control editAnuncio form_selector pais" id="f_pais" onchange="verProvincias(this.value,0)" >
                                            <option value="0">---o---</option>
                                            <?php
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="provincia">Provincia:<span class="campObligatorio">&nbsp;&nbsp;*</span></label>
                                        <select name="f_provincia" onChange="verCiudades(this.value,0)" class="form-control editAnuncio form_selector f_provincia" id="f_provincia" disabled="disabled" >
                                            <option value="0">---o---</option>
                                        </select>&nbsp;&nbsp;<img src="images/cargando.gif" width="15" height="15" style="display:none" id="cargProv" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="ciudad">Ciudad:<span class="campObligatorio">&nbsp;&nbsp;*</span></label>
                                        <select name="f_ciudad" class="form-control editAnuncio form_selector f_ciudad" id="f_ciudad" disabled="disabled" >
                                            <option value="0">---o---</option>
                                        </select>&nbsp;&nbsp;<img src="images/cargando.gif" width="15" height="15" style="display:none" id="cargCiu" />
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea style="height:120px !important; width:96% !important;" name="f_descripcion" id="f_descripcion" cols="70" rows="6" maxleng class="form-control-2 editAnuncio form_campo_comentarios"><?php echo $list[0]['comentario']?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="f_idiomas[]" id="f_idiomas" class="idioma form-control editAnuncio" multiple="multiple" >
                                            ...
                                            while($arryFP = mysqli_fetch_array($sqlFP)){
                                                ...
                                                //echo "<div class='form-control editAnuncio checkEspecificacion'><label><input type='checkbox' id='FP_".$arryFP["ID"]."' name='FP_".$arryFP["ID"]."' value='1' ".($checkFP==1 ? "checked='checked'" : "").">&nbsp;".$arryFP["Nombre"]."</label></div>";
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="f_email" id="f_email" type="text" maxlength="40"  class="form-control editAnuncio form_celdainput"  />
                                </div>
                                </div> -->
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="pago">Formas de pago:</label>
                                        <select name="forma_pago[]" class="forma_pago form-control editAnuncio" multiple="multiple" >
                                          <?php 
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $list[0]['medidas']?>" name="f_medidas" id="f_medidas" type="text" maxlength="20" class="form-control editAnuncio form_celdainput"  />
                                </div>
                                </div>
                                <div class="col-lg-12">
                                </div>							
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="f_altura" id="f_altura" class="altura form-control editAnuncio form_celdainput"  >
                                        <option value=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select  name="f_ojos" id="f_ojos" class="ojos form-control editAnuncio form_celdainput" >
                                        <option value=""> </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select  name="f_peso" id="f_peso" class="peso form-control editAnuncio form_celdainput" >
                                        <option value=""> </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="f_nacionalidad" id="f_nacionalidad"class="nacionalidad form-control editAnuncio form_celdainput" >
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select  name="f_pelo" id="f_pelo" class="pelo form-control editAnuncio form_celdainput" >
                                        <option value=""></option>
...
<script>
  ...
  function toggleTab(tabIndex) {
    ...
    const tabBtn = document.querySelectorAll('.tab-btn')[tabIndex - 1];

    if (currentTab === tabIndex) {
      // Si el mismo tab está activo, ocultarlo
...
<script>
  ...
  function readFile(input) {
    if (input.files && input.files[0]) {
      ...
      reader.onload = function (e) {
        ...
        new bootstrap.Modal(document.getElementById('cropImagePop')).show();
  ...
  document.addEventListener('DOMContentLoaded', function () {
    $uploadCrop = $('#upload-demo').croppie({
      viewport: { width: 300, height: 350, type: 'square' },
    ...
    $('.item-img').on('change', function () { readFile(this); });
