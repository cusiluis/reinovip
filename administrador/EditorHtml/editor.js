...
this.btnList = {
    ...
    "subscript":      ['SubScript',            'Subindice',            'editor_action(this.id)',  'ed_format_sub.gif'],
    "superscript":    ['SuperScript',          'Superindice',          'editor_action(this.id)',  'ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          'Justificado Izquierda','editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        'Centrado',             'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyfull":    ['JustifyFull',          'Justificado',          'editor_action(this.id)',  'ed_align_justify.gif'],
    "justifyright":   ['JustifyRight',         'Justificado Derecha',  'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    'Lista Ordenada',       'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  'Lista con Vinetas',    'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              'Indentado Decreciente','editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Indentado Creciente',  'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            'Color de Tipografia',  'editor_action(this.id)',  'ed_color_fg.gif'],
    ...
    "insertimage":    ['InsertImage',          'Insertar Imagen',      'editor_action(this.id)',  'ed_image.gif'],
    ...
    "popupeditor":    ['popupeditor',          'Agrandar el Editor',   'editor_action(this.id)',  'fullscreen_maximize.gif'],
...
function editor_updateToolbar(objname,action) {
  ...
  var IDList = Array('Bold','Italic','Underline','StrikeThrough','SubScript','SuperScript','JustifyLeft','JustifyCenter','JustifyFull','JustifyRight','InsertOrderedList','InsertUnorderedList');
