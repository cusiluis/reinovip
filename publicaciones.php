...
<title><?php echo $TituloSitio?></title>
	...
	<link rel="stylesheet" href="CssRegistro.css?v=2.1" />
	...
	<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
        ...
        <link rel="stylesheet" href="http://reinovip.com/CssIndex.css?v=2.0" />
    ...
    float: left !important;
								...
								<?php foreach ($list as $data):?>
									<tr style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd;">
                                        <td width="250"><img src="https://reinovip.com/fotos/<?php echo $data['imagen']?>" style='width:250px;'></td>
                        ...
                        <div class="login-box" style="height:1200px;margin-top:50px;margin-bottom:50px;display:inline-table;">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div style="float:left;width:130px;">
                                    ...
                                    <input style="width:10px;" id= "f_whatsapp" type="checkbox" name="f_whatsapp" <?php if($list[0]['whatsapp']==1):?>checked<?php endif;?>/><img src="https://www.reinovip.com/img/wp.png" style="width:14px;margin: 0 4px;"><label style="width:65px;font-size:.7rem;">Whatsapp </label>
                                    <input style="width:10px;margin-top:0px;" type="checkbox" name="f_telegram" <?php if($list[0]['telegram']==1):?>checked<?php endif;?>/><img src="https://www.reinovip.com/img/tg.png" style="width:14px;margin: 0 4px;"><label style="width:65px;font-size:.7rem;">Telegram </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pictures" style="display:none;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="login-box" style="margin-bottom:50px;display: inline-block;">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="ci-user d-flex align-items-center justify-content-center">
                                            ...
                                            <a style="width:100%;color:#793a57 !important; !important; font-size:.8rem;" href="javascript:;" class="userEditeBtn btn-default bg-blue position-relative">
                                                ...
                                                <div class="login-box" style="width:350px;float:right;border-radius:5px;">
                ...
                <form class="formRegistro" action="editar_imagenes.php" enctype="multipart/form-data" name="formC" id="formC" method="POST" onsubmit="">
								...
								<?php foreach ($list[0]['imagenes'] as $data):?>
                                        ...
                                        <td style="text-align: center;"><img src="https://reinovip.com/fotos/<?php echo $data['imagen'];?>" style='width:90px;height: 141px;'>
                                        <br>    
                                        <br>    
